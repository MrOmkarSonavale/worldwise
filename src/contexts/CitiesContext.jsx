...
const BASE_URL = 'https://server-json-ef7x.onrender.com';
...
function CitiesProvider({ children }) {
	...
	const [{ cities, isLoading, currentCity }, dispatch] = useReducer(reducer, innitalState);
...
function useCities() {
	...
	if (context === undefined) throw new Error('Citiescontex outside of the  CitiesProvider')
